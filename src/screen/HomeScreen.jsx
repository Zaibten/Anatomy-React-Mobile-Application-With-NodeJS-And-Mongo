...
<html>
  ...
  <body>
    <iframe
      id="sketchfab-iframe"
      src="https://sketchfab.com/models/2f888b3ad214430fb895604437090786/embed?autostart=1&annotations_visible=1&preload=true"
    ...
    <script>
      ...
      // Camera position
      const reset = { eye: [0, -2.8, 1], target: [0, 8, 0] };
      ...
      let api;
      client.init('2f888b3ad214430fb895604437090786', {
        success: (apiInstance) => {
          api = apiInstance;
