...
const RespiratorySystemScreen = ({ navigation }) => {
...
<html>
  ...
  <body>
    <iframe
      id="sketchfab-iframe"
      src="https://sketchfab.com/models/b8e2de3d64d24becadb3d4f12b2ec567/embed?autostart=1&annotations_visible=1&preload=true"
    ...
    <script>
      ...
      // Camera position
      const reset = { eye: [0, -200, 180], target: [0, 0, 0] };
      ...
      let api;
      client.init('b8e2de3d64d24becadb3d4f12b2ec567', {
        success: (apiInstance) => {
          api = apiInstance;
